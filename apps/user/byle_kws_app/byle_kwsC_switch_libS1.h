...
/*
  ...
  /*关键词阈值调整*/
static const  float confidence[12] =
{
...
#ifdef CMD_NEED_TWO_TIMES_EN         //BZ
#define USER_CHANGE_COLOR  eCMD_changecolor             //BZ
#endif         //BZ
...
static const u16 Byle_kws_msg_table[]=
	{
	KEY_NULL,//eCMD_wakeup_uni,  //"XiaoaiXiaoai",
	MSG_LED_USB_NIGHT_ON,//eCMD_open0,     //"KaiDeng",
	MSG_LED_USB_NIGHT_ON,//eCMD_default_open,   //"DaKaiDianDeng",
	MSG_LED_USB_NIGHT_ON,//eCMD_open1,          //"WoHuiLaiLe",
	MSG_LED_OFF,//eCMD_close0,       //"GuanDeng",
	MSG_LED_OFF,//eCMD_default_close,   //"GuanBiDianDeng",
	MSG_LED_OFF,//eCMD_close2,			//"WoShuiJueLe",
	MSG_LED_OFF,//eCMD_close1,			//"WochuQuLe",
	MSG_LED_COLOR_DISP_MODE_SEL_NO_WY,//eCMD_changecolor,    //"BianYanSe",
	MSG_LED_COLOR_DISP_MODE_SEL_NO_WY,//eCMD_musicmode,   	//    "GaiYanSe",
	MSG_LED_VOICE_BRIGHT_UP,//eCMD_brightthelight,   // "TiaoLiangYiDian",
	MSG_LED_VOICE_BRIGHT_DOWM,//eCMD_dimthelight,   	//"TiaoanYiDian",
	
	KEY_NULL,//eCMD_warmmode,  //"HuangSeGuang",
	KEY_NULL,//eCMD_coolmode,   //"BaiSeGuang",
	KEY_NULL,//eCMD_setlight,  //"SheZhiDingShi",
	KEY_NULL,//eCMD_sleep10min, //"ShiFenZhongHouGuanDeng",
	KEY_NULL,//eCMD_sleep30min,     //"SanShiFenZhongHouGuanDeng",
	KEY_NULL,//eCMD_cancelsleepoff,		//"QuXiaoDingShi",
