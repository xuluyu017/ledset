...
def _packet_tones(file_name_list):
    ...
    os.system("../../../../../../cpu/br25/tools/packres -n tone -o tone_py.cfg " + packet_arg)
    shutil.copyfile('tone_py.cfg', '../../../../../../cpu/br25/tools/tone.cfg')
    ...
    for item in cmd_replay_json:
        ...
        if item["cmd"] == "asr_timeout_uni":
            ...
            for hash in hash_list:
                ...
                content_map_cnt += 1
            # g_nlu_content_str[]
            content_ext_str += "  [" + type + "] = {\"" + item_cmd + "\", \"" + _joint_pcm_list_str(item["pcm"]) + "\"},\n"
            content_cnt += 1
...
""")
    ...
    inc_file.write("\n")
    inc_file.write("#define NLU_CONTENT_SIZE {}\n".format(content_cnt))
    inc_file.write("#define NLU_CONTENT_MAP_SIZE {}\n".format(content_map_cnt))
    inc_file.write("\n")
    inc_file.write("#endif\n")
    inc_file.close()
