...
#define     DEBUG_USED_UARTX    0//0/1

#if (DEBUG_USED_UARTX == 0)
#define     DEBUG_UART      JL_UART0
#define     DEBUG_FO_UART_TX    FO_UART0_TX
#define     DEBUG_PFI_UART_RX   PFI_UART0_RX
#else
#define     DEBUG_UART      JL_UART0
#define     DEBUG_FO_UART_TX    FO_UART0_TX
#define     DEBUG_PFI_UART_RX   PFI_UART0_RX
...
void uart_init(u32 fre)
{
    if (TCFG_UART_TX_PORT < IO_PORT_MAX) {
        ...
        gpio_set_fun_output_port(TCFG_UART_TX_PORT, DEBUG_FO_UART_TX, 1, 1);
    }
    ...
    if (TCFG_UART_RX_PORT < IO_PORT_MAX) {
        ...
        gpio_set_fun_input_port(TCFG_UART_RX_PORT, DEBUG_PFI_UART_RX);
