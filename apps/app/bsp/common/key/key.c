...
void key_table_sel(void *msg_filter)
{
  ...
  #ifndef KEY_SCAN_TIME     //BZ        US320_WY_V7_BAT_KEY_SHAKE
...
void key_init(void)
{
    ...
    d_irkey_init();
#endif
  #if KEY_IO_EN|KEY_AD_EN|KEY_IR_EN|KEY_MATRIX_EN|KEY_MIC_EN
  key_table_sel(user_key_msg_filter);
  sys_s_hi_timer_add(NULL, key_scan, KEY_SCAN_TIME);//2);       //BZ  US320_WY_V7_BAT_KEY_SHAKE
  #endif
}
