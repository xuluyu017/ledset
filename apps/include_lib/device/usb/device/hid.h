...
#define USB_AUDIO_REPORT_ID     1
#define USB_AUDIO_NONE_IOS      USB_AUDIO_REPORT_ID
#define USB_AUDIO_VOLUP_IOS     ((BIT(0) << 8) | USB_AUDIO_REPORT_ID)
#define USB_AUDIO_VOLDOWN_IOS   ((BIT(1) << 8) | USB_AUDIO_REPORT_ID)
#define USB_AUDIO_PP_IOS        ((BIT(2) << 8) | USB_AUDIO_REPORT_ID)
...
u32 hid_register(void *p);
void *usb_hid_init(void);
void *usb_hid_init_ios(void);
void *usb_hid_init_android(void);
