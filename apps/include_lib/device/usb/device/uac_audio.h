...
struct uac_info_t {
    ...
    void (*uac_speaker_stream_open)(u32 samplerate, u32 ch, u32 res);
...
u32 uac_audio_ip15_desc_config(const usb_dev usb_id, u8 *ptr, u32 *cur_itf_num);
