...
#define IO_PORTB_07 				(IO_GROUP_NUM * 1 + 7)          //BZ	US320_WY_V7_BAT_KEY_SHAKE
#define IO_PORTB_08 				(IO_GROUP_NUM * 1 + 8)          //BZ
...
enum CLK_OUT_SOURCE {
    ...
    CLK_OUT_RC250K,
    CLK_OUT_RTC_OSC,
    CLK_OUT_RING_CLK,//CLK_OUT_XOSC_12M,
    CLK_OUT_LRC_200K,
    CLK_OUT_PLL_96M,
    CLK_OUT_STD_48M,
    CLK_OUT_STD_24M,
...
enum CLK_OUT_SOURCE3 {
    CLK_OUT3_DISABLE,
    CLK_OUT3_RC16M,
    CLK_OUT3_LRC_CLK,
    CLK_OUT3_SYS_PLL_D3P5,
    CLK_OUT3_SYS_PLL_D2P5,
    CLK_OUT3_SYS_PLL_D2P0,
    CLK_OUT3_SYS_PLL_D1P5,
    CLK_OUT3_SYS_PLL_D1P0,
};
...
enum OUTPUT_CH_SIGNAL {
    ...
    OUTPUT_CH_SIGNAL_NULL0,
    OUTPUT_CH_SIGNAL_NULL1,
    OUTPUT_CH_SIGNAL_P33_DBG_OUT0,
    OUTPUT_CH_SIGNAL_P33_DBG_OUT1,
};
...
//ICH_CON1:
    ...
    INPUT_CH_SIGNAL_ASS_DBG_DATI0,
    INPUT_CH_SIGNAL_ASS_DBG_DATI1,
    INPUT_CH_SIGNAL_ASS_DBG_DATI2,
    INPUT_CH_SIGNAL_ASS_DBG_DATI3,
    INPUT_CH_SIGNAL_ASS_DBG_DATI4,
//ICH_CON2:
...
enum INPUT_CH_TYPE {
    ...
    INPUT_CH_TYPE_USBDP_IN,
    INPUT_CH_TYPE_USBDM_IN,
};
 ...
 * @return 0：成功  非0：失败
 */
u32 gpio_set_pull_up(u32 gpio, enum gpio_pullup_mode value);
 ...
 * @return 0：成功  非0：失败
 */
u32 gpio_set_pull_down(u32 gpio, enum gpio_pulldown_mode value);
...
u32 gpio_port_wkup_ich_enable(u32 gpio);
u32 gpio_port_wkup_ich_disable(u32 index);
...
void gpio_clk_out2(u8 gpio, enum CLK_OUT_SOURCE clk);
void gpio_clk_out3(u8 gpio, enum CLK_OUT_SOURCE3 clk, u8 div);//clk/4/div(div:0~63)
...
int gpio_set_mode(u8 gpio, enum gpio_mode mode);
