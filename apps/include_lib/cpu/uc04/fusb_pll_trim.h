...
#define FUSB_MAX_TH(x)     (48 * (1000 + x))
#define FUSB_MIN_TH(x)     (48 * (1000 - x))
...
void fusb_pll_trim_close(void);
u8 fusb_pll_trim(u8 mode, u16 trim_prd, u16 freq_deviation);
u8 get_usb_upgrade_mode();
