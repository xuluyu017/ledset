...
#define FO_UART1_RTS        ((20 << 2)|BIT(1)|BIT(0))
#define FO_MCPWM0_H        ((21 << 2)|BIT(1)|BIT(0))
#define FO_MCPWM1_H        ((22 << 2)|BIT(1)|BIT(0))
#define FO_MCPWM0_L        ((23 << 2)|BIT(1)|BIT(0))
#define FO_MCPWM1_L        ((24 << 2)|BIT(1)|BIT(0))
#define FO_CHAIN_OUT0        ((25 << 2)|BIT(1)|BIT(0))
#define FO_CHAIN_OUT1        ((26 << 2)|BIT(1)|BIT(0))
#define FO_CHAIN_OUT2        ((27 << 2)|BIT(1)|BIT(0))
#define FO_CHAIN_OUT3        ((28 << 2)|BIT(1)|BIT(0))
