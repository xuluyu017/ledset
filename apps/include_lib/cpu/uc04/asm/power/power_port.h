...
#define 	SPI0_WP_D2_A	IO_PORTA_12
#define 	SPI0_HOLD_D3_A	IO_PORTA_13
...
#define		PINR_DEFAULT_IO IO_PORTA_01

#define		MCLR_PORT		IO_PORTA_01

#define     LVD_PORT        IO_PORTA_10
