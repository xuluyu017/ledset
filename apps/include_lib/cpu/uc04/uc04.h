...
typedef struct {
    ...
    __RW __u32(RESERVED_AUDSYS[24 - 14]);
    ...
    __RW __u32(ADC_CON1);   /* 07 */
    __WO __u16(ADC_COP);    /* 08 */
    __WO __u32(ADC_DCW);    /* 09 */
    __RO __u32(ADC_DCR);    /* 10 */
    //__RW __u32 (A2D_CON);   /* 11 */
    //__RW __u32 (A2D_CON0);  /* 12 */
    //__RW __u32 (A2D_CON1);  /* 13 */
    //__RW __u32 (A2D_CON2);  /* 14 */
    //__RW __u32 (A2D_CON3);  /* 15 */
    //__RW __u32 (A2D_CON4);  /* 16 */
    //__RW __u32 (A2D_CON5);  /* 17 */
    //__RW __u32 (A2D_CON6);  /* 18 */
    //__RW __u32 (A2D_CON7);  /* 19 */
    //__RW __u32 (A2D_CON8);  /* 20 */
    //__RO __u32 (A2D_CON9);  /* 21 */
    //__RO __u32 (A2D_CON10); /* 22 */
    //__RO __u32 (A2D_CON11); /* 23 */
    __RW __u32(AUD_CON);    /* 24 */
    __RW __u32(RESERVED_AUDPRJ[40 - 12]);
} JL_AUDIO_TypeDef;
...
//............. 0x1e00 - 0x1eff............ for efuse
typedef struct {
    __RW __u32 CON;
    __RO __u32 RDAT;
} JL_EFUSE_TypeDef;

#define JL_EFUSE_BASE          (ls_base + map_adr(0x1e, 0x00))
...
//#define JL_PORTP                        ((JL_PORTP_TypeDef *)JL_PORTP_BASE)
...
#define JL_IOMC_BASE                    (ls_base + map_adr(0x3d, 0x05))
